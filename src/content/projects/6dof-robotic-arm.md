...
This project presents the work I have completed messing around with the AR4 platform. I explore manipulation, computer vision, and ROS2
among other fundamental concepts in robotic manipulation. Join me as I learn as much as I can while I solve problems and implement solutions.

## Key Features

### Robotic Platform
- **Annin Robotics AR4**: [The Robot Anyone Can Build](https://anninrobotics.com/)
